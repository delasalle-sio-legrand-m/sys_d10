...
contexts=[
    ...
    "Influence l'aptitude à diminuer les soins et dimminuer les dégats infligés ainsi qu'augmenter les dégats de bois",
    "Influence l'aptitude à détruire les boucliers et diminuer les défences ainsi que les dégats des attaques élémentaires de foudre"
]
texts=[
    "Affinité à l'Eau (Ag)",
